...
router.post("/postagens/nova", eAdmin, (req, res) => { //falta fazer validações
    var erros = []
...
router.post("/postagem/edit", eAdmin, (req, res) => { //fazer validação
...
//--Outra forma de deletar-- (Não indicado)
